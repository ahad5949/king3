...
print("\033[1;92m   [•] WALLCOME TO AHAD TOOL \033[1;30m")
os.system('espeak -a 300 "Wallcome to AHAD tool"')
...
################################################
  ...
  [✓] AUTHOR    \033[1;91m: \033[1;91AHAD ISLAM             
...
def Nehal Khan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[AHAD ISLAM]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
